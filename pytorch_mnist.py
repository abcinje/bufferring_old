...
if __name__ == '__main__':
    ...
    train_dataset = \
        datasets.MNIST('data-%d' % bfr.rank, train=True, download=True,
    ...
    test_dataset = \
        datasets.MNIST('data-%d' % bfr.rank, train=False, transform=transforms.Compose([
            transforms.ToTensor(),
            transforms.Normalize((0.1307,), (0.3081,))
        ]))
    # Horovod: use DistributedSampler to partition the test data.
    test_sampler = torch.utils.data.distributed.DistributedSampler(
        test_dataset, num_replicas=bfr.size, rank=bfr.rank)
